...
import { ChevronDown, Calendar, User, BookOpen } from 'lucide-react';
...
export const CustomerNavDropdown: React.FC<CustomerNavDropdownProps> = ({ isScrolled }) => {
  ...
  const buttonClass = `px-3 xl:px-4 py-2 xl:py-2.5 font-semibold text-xs xl:text-sm
