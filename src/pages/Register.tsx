...
export const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (formData.pin !== confirmPin) {
      validationErrors.push('PINs do not match');
    }
        ...
        <div className="max-w-md mx-auto">
          <div className="bg-white rounded-2xl shadow-2xl p-8 sm:p-10">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Join FitPreeti Yoga Institute</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">10-digit phone number (starting with 6-9)</p>
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-red-600 text-white py-3 px-4 rounded-xl font-semibold hover:bg-red-700 focus:outline-none focus:ring-4 focus:ring-red-300 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center mt-6"
              >
                {isLoading ? (
                  <>
