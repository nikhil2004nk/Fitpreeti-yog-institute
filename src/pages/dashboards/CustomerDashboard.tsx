...
import { Calendar, Clock, MapPin, Phone, Mail, User, X } from 'lucide-react';
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-600">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900 mt-2">{completedBookings.length}</p>
                </div>
                ...
                {loading ? (
                  ...
                  <div className="space-y-4">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="space-y-1 text-sm text-gray-600">
                              ...
                              {booking.special_requests && (
                                <p className="text-gray-500 italic">"{booking.special_requests}"</p>
                              )}
                            </div>
                          </div>
                    ...
                    {bookings.length > 5 && (
                      <Link
                        to={ROUTES.BOOKING}
                        className="block text-center text-red-600 hover:text-red-700 font-semibold py-2"
                      >
                        View All Bookings →
                      </Link>
                    )}
